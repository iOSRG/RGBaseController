...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RGBaseController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/18607304107@163.com/RGBaseController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '18607304107@163.com' => 'gui.ren@hand-china.com' }
  s.source           = { :git => 'https://github.com/18607304107@163.com/RGBaseController.git', :tag => s.version.to_s }
